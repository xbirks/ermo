...
function IndexMaster({municipio}) {
  ...
  return (
    <Inner>
      <VideoIndex
        desktopmp4="https://res.cloudinary.com/ermostudio/video/upload/f_auto,q_auto,vc_auto/v1746285229/ermo-proyectos-2024-header-desktop_REDRES_jmurzj.mp4"
        mobilemp4="https://res.cloudinary.com/ermostudio/video/upload/f_auto,q_auto,vc_auto/v1746275066/ermo-proyectos-2024-mobile-desktop_360x640_ityphc.mp4"
      />
