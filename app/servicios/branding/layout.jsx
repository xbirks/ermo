...
export const metadata = {
  ...
  //GENERIC
  title: 'Identidad corporativa y logotipos para empresas en Valencia',
  ...
  openGraph: {
    ...
    site_name: 'Identidad corporativa y logotipos para empresas en Valencia',
    locale: 'es_ES',
  },

  // TWITTER
  twitter: {
    card: 'Identidad corporativa y logotipos para empresas en Valencia',
    site: '@ermo.es',
    creator: '@ermo.es',
    title: 'Identidad corporativa y logotipos para empresas en Valencia',
    description: 'Otorgamos personalidad y estilo a la identidad visual de tu empresa. Desde el logotipo, hasta el diseño sonoro o las animaciones. E incluso las fotos de tu equipo.',
