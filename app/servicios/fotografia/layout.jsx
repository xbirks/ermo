...
export const metadata = {
  ...
  //GENERIC
  title: 'Hacemos fotografía comercial y de producto en Valencia',
  ...
  openGraph: {
    ...
    site_name: 'Hacemos fotografía comercial y de producto en Valencia',
    locale: 'es_ES',
  },

  // TWITTER
  twitter: {
    card: 'Hacemos fotografía comercial y de producto en Valencia',
    site: '@ermo.es',
    creator: '@ermo.es',
    title: 'Hacemos fotografía comercial y de producto en Valencia',
    description: 'Desde ERMO estudio ofrecemos el servicio de fotografía profesional enfocada a la gastronomía y a la fotografía de producto y de e-commerce.',
