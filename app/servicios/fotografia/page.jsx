...
export default function FotografiaPage({municipio}) {
    ...
    <FotografiaLayout municipio="en Cuenca">
        <Servicios
            desktopmp4="https://res.cloudinary.com/ermostudio/video/upload/v1746286660/FOTO_Desktop_1_k42ews.mp4"
            mobilemp4="https://res.cloudinary.com/ermostudio/video/upload/v1746286659/FOTO_Mobile_1_prd4oj.mp4"
