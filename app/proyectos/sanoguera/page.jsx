...
export default function SanogueraPage() {
    ...
    <SanogueraLayout>
        <Proyectos
            ...
            videoproyecto="https://www.ermo.es/videos/sanoguera/SANOGUERA_Wrap.mp4"
            explicacion={ <>
            ...
            image1="https://www.ermo.es/videos/sanoguera/SANOGUERA_mini_2.mp4"
            image2="https://www.ermo.es/videos/sanoguera/SANOGUERA_mini_3.mp4"
        ></Proyectos>
    </SanogueraLayout>
